...
$loginPortalName = !empty($school['name']) ? $school['name'] : 'School Portal';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo htmlspecialchars($loginLogoUrl); ?>">
...
<body class="antialiased min-h-screen flex items-center justify-center p-6">
    ...
    <div class="w-full max-w-md animate-fadeInUp">
        ...
        <div class="flex flex-col items-center mb-8">
            ...
            <h1 class="text-2xl font-black text-slate-900 tracking-tight"><?php echo htmlspecialchars($loginPortalName); ?></h1>
            <p class="text-slate-500 text-sm mt-1 font-medium"><?php echo !empty($school) ? 'School Portal' : 'Secure Access Gateway'; ?></p>
        </div>
