        ...
        <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <div class="">
                ...
                <div class="">
                    ...
                    <a href="guardian-list.html" class="text-secondary-light hover-text-primary hover-underline"> /
                        Guardian</a>
                    ...
                    <div class="d-flex gap-32 flex-md-row flex-column">
                        <div class="max-w-300-px w-100 text-center">
                            <figure class="mb-24 w-120-px h-120-px mx-auto rounded-circle overflow-hidden">
                                <img src="https://academixsuite.com/tenant/assets/images/thumbs/teacher-details-img.png" alt="guardian Image"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="d-flex align-items-center gap-12">
                                            <figure class="w-48-px h-48-px rounded-circle overflow-hidden mb-0">
                                                <img src="https://academixsuite.com/tenant/assets/images/thumbs/guardian-img1.png" alt="Guardian Image"
                            ...
                            <div class="bg-hover-neutral-50 p-20">
                                <div class="row g-4">
                                    <div class="col-sm-4">
                                        <div class="d-flex align-items-center gap-12">
                                            <figure class="w-48-px h-48-px rounded-circle overflow-hidden mb-0">
                                                <img src="https://academixsuite.com/tenant/assets/images/thumbs/guardian-img2.png" alt="Guardian Image"
                                                    class="flex-shrink-0 w-100 h-100 object-fit-cover">
                                            </figure>
                                            <div class="">
        ...
        <div class="p-20">
            <div class="d-flex align-items-center gap-20">
                <figure class="w-72-px h-72-px rounded-circle overflow-hidden mb-0">
                    <img src="https://academixsuite.com/tenant/assets/images/thumbs/student-details-img.png" alt="guardian Image"
                        class="w-100 h-100 object-fit-cover">
                </figure>
                <div class="flex-grow-1">
