    ...
    <div class="dropdown profile-dropdown">
      <button type="button" class="profile-dropdown__button d-flex align-items-center justify-content-between p-10 w-100 overflow-hidden bg-neutral-50 radius-12 " data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">
        <span class="d-flex align-items-start gap-10">
          <img src="https://academixsuite.com/tenant/assets/images/thumbs/leave-request-img2.png" alt="Thumbnail" class="w-40-px h-40-px rounded-circle object-fit-cover flex-shrink-0">
      ...
      <ul class="dropdown-menu dropdown-menu-lg-end border p-12">
        <li>
          <a href="student-details.html" class="dropdown-item rounded text-secondary-light bg-hover-neutral-200 text-hover-neutral-900 d-flex align-items-center gap-2 py-6">
        ...
        <li>
          <a href="login.html" class="dropdown-item rounded text-secondary-light bg-hover-neutral-200 text-hover-neutral-900 d-flex align-items-center gap-2 py-6">
...
<main class="dashboard-main">
            ...
            <div class="max-h-400-px overflow-y-auto scroll-sm pe-8">
              <div class="form-check style-check d-flex align-items-center justify-content-between mb-16">
                <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="english">
                  <span class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3">
                    <img src="https://academixsuite.com/tenant/assets/images/flags/flag1.png" alt="Image" class="w-36-px h-36-px bg-success-subtle text-success-main rounded-circle flex-shrink-0">
              ...
              <div class="form-check style-check d-flex align-items-center justify-content-between mb-16">
                <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="japan">
                  <span class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3">
                    <img src="https://academixsuite.com/tenant/assets/images/flags/flag2.png" alt="Image" class="w-36-px h-36-px bg-success-subtle text-success-main rounded-circle flex-shrink-0">
              ...
              <div class="form-check style-check d-flex align-items-center justify-content-between mb-16">
                <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="france">
                  <span class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3">
                    <img src="https://academixsuite.com/tenant/assets/images/flags/flag3.png" alt="Image" class="w-36-px h-36-px bg-success-subtle text-success-main rounded-circle flex-shrink-0">
              ...
              <div class="form-check style-check d-flex align-items-center justify-content-between mb-16">
                <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="germany">
                  <span class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3">
                    <img src="https://academixsuite.com/tenant/assets/images/flags/flag4.png" alt="Image" class="w-36-px h-36-px bg-success-subtle text-success-main rounded-circle flex-shrink-0">
              ...
              <div class="form-check style-check d-flex align-items-center justify-content-between mb-16">
                <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="korea">
                  <span class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3">
                    <img src="https://academixsuite.com/tenant/assets/images/flags/flag5.png" alt="Image" class="w-36-px h-36-px bg-success-subtle text-success-main rounded-circle flex-shrink-0">
              ...
              <div class="form-check style-check d-flex align-items-center justify-content-between mb-16">
                <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="bangladesh">
                  <span class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3">
                    <img src="https://academixsuite.com/tenant/assets/images/flags/flag6.png" alt="Image" class="w-36-px h-36-px bg-success-subtle text-success-main rounded-circle flex-shrink-0">
              ...
              <div class="form-check style-check d-flex align-items-center justify-content-between mb-16">
                <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="india">
                  <span class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3">
                    <img src="https://academixsuite.com/tenant/assets/images/flags/flag7.png" alt="Image" class="w-36-px h-36-px bg-success-subtle text-success-main rounded-circle flex-shrink-0">
              ...
              <div class="form-check style-check d-flex align-items-center justify-content-between">
                <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="canada">
                  <span class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3">
                    <img src="https://academixsuite.com/tenant/assets/images/flags/flag8.png" alt="Image" class="w-36-px h-36-px bg-success-subtle text-success-main rounded-circle flex-shrink-0">
  ...
  <a href="add-new-student.html" class="btn btn-primary-600 d-flex align-items-center gap-6 ">
                        ...
                        <table class="table bordered-table mb-0 data-table" id="dataTable" data-page-length='10'>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="https://academixsuite.com/tenant/assets/images/thumbs/avatar-img1.png" alt="Image" class="flex-shrink-0 me-12 radius-8">
                                            <div class="">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-lg-end border p-12">
                                                ...
                                                <li>
                                                    <a href="edit-teacher.html" class="dropdown-item rounded text-secondary-light bg-hover-neutral-200 text-hover-neutral-900 d-flex align-items-center gap-2 py-6">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="https://academixsuite.com/tenant/assets/images/thumbs/avatar-img2.png" alt="Image" class="flex-shrink-0 me-12 radius-8">
                                            <div class="">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="https://academixsuite.com/tenant/assets/images/thumbs/avatar-img3.png" alt="Image" class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-lg-end border p-12">
                                                ...
                                                <li><a href="edit-teacher.html" class="dropdown-item rounded text-secondary-light bg-hover-neutral-200 text-hover-neutral-900 d-flex align-items-center gap-2 py-6"><i class="ri-edit-2-line"></i>Edit</a></li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="https://academixsuite.com/tenant/assets/images/thumbs/avatar-img4.png" alt="Image" class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="https://academixsuite.com/tenant/assets/images/thumbs/avatar-img5.png" alt="Image" class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="https://academixsuite.com/tenant/assets/images/thumbs/avatar-img6.png" alt="Image" class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="https://academixsuite.com/tenant/assets/images/thumbs/avatar-img7.png" alt="Image" class="flex-shrink-0 me-12 radius-8">
                                            <div>
