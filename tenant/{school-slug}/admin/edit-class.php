        ...
        try {
            ...
            switch ($action) {
                ...
                case 'update_class':
                    ...
                    $stmt = $schoolDb->prepare("
                        UPDATE classes SET
                            ...
                            academic_year_id = ?, is_active = ?, updated_at = NOW()
                ...
                case 'edit_section':
                    ...
                    $stmt = $schoolDb->prepare("
                        UPDATE sections SET
                            ...
                            class_teacher_id = ?, is_active = ?, updated_at = NOW()
                        WHERE id = ? AND school_id = ?
                    ");
                    $stmt->execute([
                        $_POST['name'],
                ...
                case 'delete_section':
                    ...
                    // Soft delete
                    $stmt = $schoolDb->prepare("UPDATE sections SET is_active = 0, updated_at = NOW() WHERE id = ? AND school_id = ?");
                ...
                case 'toggle_class_status':
                    ...
                    $stmt = $schoolDb->prepare("UPDATE classes SET is_active = ?, updated_at = NOW() WHERE id = ? AND school_id = ?");
