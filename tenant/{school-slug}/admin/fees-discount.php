...
<div
    ...
    <form method="POST" action="" class="d-flex flex-column p-20">
        <input type="hidden" name="action" value="create_fees_discount">
        <div class="row g-3">
            <div class="col-sm-12">
                <div class="">
                    ...
                    <input type="text" class="form-control" id="sectionName" name="name" placeholder="Enter Group Name">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="">
                    ...
                    <select id="discountType" name="discount_type" class="form-control form-select">
            ...
            <div class="col-sm-6">
                <div class="">
                    ...
                    <input type="text" class="form-control" id="discountValue" name="discount_value" placeholder="Ex: 10%">
                </div>
            </div>
            <div class="col-sm-12">
                <div class="">
...
<div
    ...
    <form method="POST" action="" class="d-flex flex-column p-20">
        <input type="hidden" name="action" value="update_fees_discount">
        ...
        <div class="row g-3">
            <div class="col-sm-12">
                <div class="">
                    ...
                    <input type="text" class="form-control" id="sectionNameEdit" name="name" placeholder="Enter Group Name">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="">
                    <label for="discountTypeEdit"
                        class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Discount Type</label>
                    <select id="discountTypeEdit" name="discount_type" class="form-control form-select">
                        <option value="Percentage" selected>Percentage</option>
                        <option value="Percentage">Percentage</option>
                    </select>
                </div>
            ...
            <div class="col-sm-6">
                <div class="">
                    <label for="discountValueEdit"
                        class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Discount Value </label>
                    <input type="text" class="form-control" id="discountValueEdit" name="discount_value" placeholder="Ex: 10%">
                </div>
            </div>
            <div class="col-sm-12">
                <div class="">
                    ...
                    <select id="sectionStatusEdit" name="status" class="form-control form-select">
                        <option value="Select a subject" selected disabled>Select Status</option>
                        <option value="Active">Active</option>
                        <option value="Inactive">Inactive</option>
                    </select>
