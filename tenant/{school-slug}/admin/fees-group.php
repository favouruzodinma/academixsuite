...
<div
    ...
    <form method="POST" action="" class="d-flex flex-column p-20">
        <input type="hidden" name="action" value="create_fees_group">
        <div class="row g-3">
            <div class="col-sm-12">
                <div class="">
            ...
            <div class="col-sm-12">
                <div class="">
                    <label for="feesType" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Fees
                        Type</label>
                    <select id="feesType" name="fees_type" class="form-control form-select">
...
<div
    ...
    <form method="POST" action="" class="d-flex flex-column p-20">
        <input type="hidden" name="action" value="update_fees_group">
        ...
        <div class="row g-3">
            ...
            <div class="col-sm-12">
                <div class="">
                    <label for="feesTypeEdit" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Fees
                        Type</label>
                    <select id="feesTypeEdit" name="fees_type" class="form-control form-select">
                        <option value="Select fees type" selected disabled>Select fees type</option>
                        <option value="May month fees">May month fees</option>
                        <option value="Admission fees">Admission fees</option>
                        <option value="Exam fees">Exam fees</option>
            ...
            <div class="col-sm-12">
                <div class="">
                    ...
                    <select id="sectionStatusTwoHere" name="status" class="form-control form-select">
                        <option value="Select a subject" selected disabled>Select Status</option>
                        <option value="Active">Active</option>
                        <option value="Inactive">Inactive</option>
                    </select>
