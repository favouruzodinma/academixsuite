...
<div class="pp-card">
    ...
    <section class="pp-panel is-active" id="pp-panel-basics">
        <form id="pp-form-basics" enctype="multipart/form-data">
            ...
            <h6 style="margin-top:22px;font-size:13px;font-weight:700;color:#374151">Hero & feature images (max 5 MB, jpg/png/webp)</h6>
            <div class="pp-grid">
                <div>
    ...
    <section class="pp-panel" id="pp-panel-programs">
        <form id="pp-form-programs" enctype="multipart/form-data">
            <input type="hidden" name="action" value="profile_save_basics">
    ...
    <section class="pp-panel" id="pp-panel-gallery">
        <form id="pp-form-gallery-add" enctype="multipart/form-data">
...
(function () {
    ...
    window.ppAddRow = function (containerId, prefix, fields) {
        ...
        fields.forEach(function (f) {
            var isChk = (f === 'is_primary' || f === 'is_inactive');
            if (isChk) {
    ...
    ['pp-form-basics','pp-form-programs','pp-form-contacts','pp-form-facilities','pp-form-gallery-add'].forEach(function (id) {
        ...
        el.addEventListener('submit', function (e) {
            ...
            postForm(el).then(function (r) {
                flash(r);
                if (r.success && id === 'pp-form-gallery-add') {
