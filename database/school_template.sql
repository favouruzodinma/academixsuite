-- database/school_template.sql
-- Complete school database schema for MariaDB
...
INSERT IGNORE INTO `roles` (`id`, `school_id`, `name`, `slug`, `description`, `permissions`, `is_system`, `created_at`) VALUES
...
INSERT IGNORE INTO `settings` (`id`, `school_id`, `key`, `value`, `type`, `category`, `created_at`, `updated_at`) VALUES
